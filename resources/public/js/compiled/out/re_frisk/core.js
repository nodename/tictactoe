...
var len__4641__auto___38940 = arguments.length;
var i__4642__auto___38941 = (0);
while(true){
if((i__4642__auto___38941 < len__4641__auto___38940)){
args__4647__auto__.push((arguments[i__4642__auto___38941]));

var G__38942 = (i__4642__auto___38941 + (1));
i__4642__auto___38941 = G__38942;
continue;
} else {
}
break;
...
return re_frisk.core.re_frame_sub.cljs$core$IFn$_invoke$arity$variadic(argseq__4648__auto__);
});

re_frisk.core.re_frame_sub.cljs$core$IFn$_invoke$arity$variadic = (function (rest){
return cljs.core.reset_BANG_.call(null,new cljs.core.Keyword(null,"id-handler","id-handler",1013135509).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,re_frisk.data.re_frame_data)),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__38937_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([cljs.core.first.call(null,p1__38937_SHARP_)],[cljs.core.deref.call(null,cljs.core.second.call(null,p1__38937_SHARP_))]);
}),cljs.core.remove.call(null,(function (p1__38938_SHARP_){
return ((cljs.core._EQ_.call(null,cljs.core.first.call(null,cljs.core.ffirst.call(null,p1__38938_SHARP_)),new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709))) || ((cljs.core.second.call(null,p1__38938_SHARP_) == null)));
...
/** @this {Function} */
re_frisk.core.re_frame_sub.cljs$lang$applyTo = (function (seq38939){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38939));
});
...
var args__4647__auto__ = [];
var len__4641__auto___38948 = arguments.length;
var i__4642__auto___38949 = (0);
while(true){
if((i__4642__auto___38949 < len__4641__auto___38948)){
args__4647__auto__.push((arguments[i__4642__auto___38949]));

var G__38950 = (i__4642__auto___38949 + (1));
i__4642__auto___38949 = G__38950;
continue;
} else {
}
break;
...
var argseq__4648__auto__ = ((((0) < args__4647__auto__.length))?(new cljs.core.IndexedSeq(args__4647__auto__.slice((0)),(0),null)):null);
return re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__4648__auto__);
});

re_frisk.core.enable_re_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic = (function (p__38944){
var vec__38945 = p__38944;
var opts = cljs.core.nth.call(null,vec__38945,(0),null);
...
re_frame.core.reg_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__38945,opts){
return (function (db,_){
return db;
});})(vec__38945,opts))
);
} else {
re_frame.core.register_sub.call(null,new cljs.core.Keyword("re-frisk.core","db","re-frisk.core/db",447694709),((function (vec__38945,opts){
return (function (db,_){
return reagent.ratom.make_reaction.call(null,((function (vec__38945,opts){
return (function (){
...
/** @this {Function} */
re_frisk.core.enable_re_frisk_BANG_.cljs$lang$applyTo = (function (seq38943){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38943));
});

re_frisk.core.enable_frisk_BANG_ = (function re_frisk$core$enable_frisk_BANG_(var_args){
var args__4647__auto__ = [];
var len__4641__auto___38952 = arguments.length;
var i__4642__auto___38953 = (0);
while(true){
if((i__4642__auto___38953 < len__4641__auto___38952)){
args__4647__auto__.push((arguments[i__4642__auto___38953]));

var G__38954 = (i__4642__auto___38953 + (1));
i__4642__auto___38953 = G__38954;
continue;
} else {
}
break;
...
var argseq__4648__auto__ = ((((0) < args__4647__auto__.length))?(new cljs.core.IndexedSeq(args__4647__auto__.slice((0)),(0),null)):null);
return re_frisk.core.enable_frisk_BANG_.cljs$core$IFn$_invoke$arity$variadic(argseq__4648__auto__);
});
...
/** @this {Function} */
re_frisk.core.enable_frisk_BANG_.cljs$lang$applyTo = (function (seq38951){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq38951));
});
...
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"views","views",1450155487),view,new cljs.core.Keyword(null,"subs","subs",-186681991)], null),cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__38955_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([p1__38955_SHARP_],[re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__38955_SHARP_], null))]);
}),subs)));

var seq__38956 = cljs.core.seq.call(null,subs);
var chunk__38957 = null;
var count__38958 = (0);
var i__38959 = (0);
while(true){
if((i__38959 < count__38958)){
var s = cljs.core._nth.call(null,chunk__38957,i__38959);
...
var G__38960 = seq__38956;
var G__38961 = chunk__38957;
var G__38962 = count__38958;
var G__38963 = (i__38959 + (1));
seq__38956 = G__38960;
chunk__38957 = G__38961;
count__38958 = G__38962;
i__38959 = G__38963;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq.call(null,seq__38956);
if(temp__5735__auto__){
var seq__38956__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__38956__$1)){
var c__4461__auto__ = cljs.core.chunk_first.call(null,seq__38956__$1);
var G__38964 = cljs.core.chunk_rest.call(null,seq__38956__$1);
var G__38965 = c__4461__auto__;
var G__38966 = cljs.core.count.call(null,c__4461__auto__);
var G__38967 = (0);
seq__38956 = G__38964;
chunk__38957 = G__38965;
count__38958 = G__38966;
i__38959 = G__38967;
continue;
} else {
var s = cljs.core.first.call(null,seq__38956__$1);
cljs.core.swap_BANG_.call(null,re_frisk.data.re_frame_data,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"subs","subs",-186681991),s], null),re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null)));


var G__38968 = cljs.core.next.call(null,seq__38956__$1);
var G__38969 = null;
var G__38970 = (0);
var G__38971 = (0);
seq__38956 = G__38968;
chunk__38957 = G__38969;
count__38958 = G__38970;
i__38959 = G__38971;
continue;
}
} else {
...
(function (){var or__4047__auto__ = re_frame.core.reg_event_db;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return re_frame.core.register_handler;
}
})().call(null,new cljs.core.Keyword("re-frisk","update-db","re-frisk/update-db",-658524246),(function (_,p__38972){
var vec__38973 = p__38972;
var ___$1 = cljs.core.nth.call(null,vec__38973,(0),null);
var value = cljs.core.nth.call(null,vec__38973,(1),null);
return value;
}));

//# sourceMappingURL=core.js.map?rel=1590529175889
