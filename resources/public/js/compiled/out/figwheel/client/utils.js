...
return (new CustomEvent(event_name,(function (){var obj39262 = {"detail":data};
return obj39262;
})()));
} else {
...
var f = (function (){var pred__39269 = cljs.core._EQ_;
var expr__39270 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39269.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39270))){
return ((function (pred__39269,expr__39270){
return (function (p1__39263_SHARP_){
return console.warn(p1__39263_SHARP_);
});
;})(pred__39269,expr__39270))
} else {
if(cljs.core.truth_(pred__39269.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39270))){
return ((function (pred__39269,expr__39270){
return (function (p1__39264_SHARP_){
return console.debug(p1__39264_SHARP_);
});
;})(pred__39269,expr__39270))
} else {
if(cljs.core.truth_(pred__39269.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39270))){
return ((function (pred__39269,expr__39270){
return (function (p1__39265_SHARP_){
return console.error(p1__39265_SHARP_);
});
;})(pred__39269,expr__39270))
} else {
return ((function (pred__39269,expr__39270){
return (function (p1__39266_SHARP_){
return console.log(p1__39266_SHARP_);
});
;})(pred__39269,expr__39270))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39273){
...
var opts = map__39274__$1;
var eval_fn = cljs.core.get.call(null,map__39274__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__39276_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39278,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1590529176374
