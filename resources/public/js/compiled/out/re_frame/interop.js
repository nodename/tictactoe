...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__29403 = cljs.core.instance_QMARK_;
var expr__29404 = reactive_val;
if(cljs.core.truth_(pred__29403.call(null,reagent.ratom.RAtom,expr__29404))){
return "ra";
} else {
if(cljs.core.truth_(pred__29403.call(null,reagent.ratom.RCursor,expr__29404))){
return "rc";
} else {
if(cljs.core.truth_(pred__29403.call(null,reagent.ratom.Reaction,expr__29404))){
return "rx";
} else {
if(cljs.core.truth_(pred__29403.call(null,reagent.ratom.Track,expr__29404))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1590529165851
