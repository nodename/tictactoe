...
var vec__30146_30149 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_30150 = cljs.core.nth.call(null,vec__30146_30149,(0),null);
var only_after_30151 = cljs.core.nth.call(null,vec__30146_30149,(1),null);
var db_changed_QMARK__30152 = (((!((only_before_30150 == null)))) || ((!((only_after_30151 == null)))));
if(db_changed_QMARK__30152){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_30150);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_30151);
...
var map__30153 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__30153__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__30153__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__30155 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__30155__$1;
var event = cljs.core.get.call(null,map__30155__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
/** @this {Function} */
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq30157){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30157));
});
...
return cljs.core.get_in.call(null,new_db,p1__30161_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__30162_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__30162_SHARP_);
...
/** @this {Function} */
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq30163){
...
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30164,G__30165,seq30163__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1590529166462
